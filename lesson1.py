...
# print(find_all_spans_in_user_info[2])
...
# find_a_by_text = soup.find('a', text='Adult')
# print(find_a_by_text)

# find_a_by_text = soup.find('a', text='Adult clothes')
# print(find_a_by_text)

# !!! Best method from re module for finding by text
# find_a_by_text = soup.find('a', text=re.compile('Adult'))
